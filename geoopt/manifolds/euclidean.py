...
from geoopt.utils import strip_tuple, size2shape
# from geoopt.geoopt.tensor import ManifoldTensor
import geoopt.tensor # 循环调用了，比较奇怪
...
class Euclidean(Manifold):
    ...
    def random_normal(self, *size, mean=0.0, std=1.0, device=None, dtype=None):
        ...
        return tensor.ManifoldTensor(tens, manifold=self)
