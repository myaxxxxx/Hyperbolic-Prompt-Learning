...
export EXP_NAME=bert_conll03_test
bs=16
epoch=30
psl=11
lr=3e-2
...
python3 run.py \
  --model_name_or_path /data02/GaoGL_GRP/GglStuA/student/pt2/pretraining_model/bert-large-uncased \
  --task_name $TASK_NAME \
  ...
  --pre_seq_len $psl \
  --output_dir checkpoints/$DATASET_NAME/bert_conll03_baselines \
