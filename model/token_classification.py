...
import setproctitle
setproctitle.setproctitle("天王盖地虎,宝塔镇河妖！")
...
class BertPrefixForTokenClassification(BertPreTrainedModel):
    ...
    def forward(
        ...
        ## add
        if self.cfg.use_hy: 
            sequence_output = pm.expmap0(sequence_output, c=self.cfg.num_c)
...
class RobertaForTokenClassification(RobertaPreTrainedModel):
    ...
    def forward(
        ...
        if self.use_hy:  
            ...
            sequence_output = pm.expmap0(sequence_output, c=self.num_c)

        # sequence_output = pm.expmap0(sequence_output, c=2)
        # print(123456666)
        # exit()
